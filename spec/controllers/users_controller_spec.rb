...
RSpec.describe UsersController, 'test users_controller' do
  ...
  describe 'active_users action' do
    it 'show template with list of active users' do
      get :active_users
      exp_user = User.new(id: 1, email: 'bb.bb@gmail.com', first_name: 'BB', last_name: 'BB', address: 'cc', status: 'admin', created_at: '2020-10-28 12:02:56', updated_at: '2020-10-28 12:02:57')
      exp_arr = Array.new
